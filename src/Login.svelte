<script>
  ...
  <main class="main-container">
    <section class="right">
      <h1 class="title">
        <i class="fa-brands fa-itunes-note"></i> Sign In
      ...
      <form class="form-container" on:submit={validar}>
        <label class="username" for="mail">
          ...
          <input  id="mail"  type="email"  class="user-input"  placeholder="E-Mail"  bind:value={email}  on:input={() => errorMail = ''}  required/>
          {#if errorMail}
        ...
        <div id="contra">
          <label class="password" for="contrasinal">
            ...
            {#if showPassword}
              <input  id="contrasinal"  type="text"  class="pass-input"  placeholder="Password"  bind:value={password}  on:input={() => errorPassword = ''}  minlength="6"  maxlength="12"  required/>
            {:else}
              <input id="contrasinal" type="password" class="pass-input" placeholder="Password" bind:value={password} on:input={() => errorPassword = ''} minlength="6" maxlength="12" required/>
            {/if}
            <i class={showPassword ? 'fa-regular fa-eye' : 'fa-regular fa-eye-slash'} on:click={togglePasswordVisibility}></i>
          </label>
          {#if errorPassword}
